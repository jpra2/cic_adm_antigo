...
class MeshManager:
    ...
    def set_k(self):
        ...
        mb.tag_set_data(self.perm_tag, self.all_volumes, np.repeat(perm_tensor, len(self.all_volumes)))
...
M1= MeshManager('9x36x36.msh')          # Objeto que armazenará as informações da malha
...
Cent_weels=[[0.5, 0.5, 0.5], [35.5, 35.5, 8.5]]
...
for e in all_volumes:
    ...
    d1_tag = int(M1.mb.tag_get_data(elem_tags[1], e, flat=True))
    if d1_tag==3:
...
self.mb.write_file("9x36x36-volume.vtk")
#M1.imprima("9x36x36")
